...
If **Save brief and stop**: write the concepts brief to `plans/eg-brainstorms/<slug>-<YYYY-MM-DD>.md` ONLY if the user confirms via one more `AskUserQuestion`:
...
- `multiSelect`: `false`
- `options`:
  1. **plans/eg-brainstorms/<slug>-<YYYY-MM-DD>.md** — "Save to the default brainstorm location."
